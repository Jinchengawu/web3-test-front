...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <p className="text-xl mb-8">使用 RainbowKit 和 WalletConnect 的 NFT 市场</p>
      ...
      <div className="space-y-4">
        ...
        <Link 
          href="/events" 
          className="block bg-purple-500 text-white px-8 py-3 rounded-lg hover:bg-purple-600 text-center"
        >
          事件监控
        </Link>
      </div>
